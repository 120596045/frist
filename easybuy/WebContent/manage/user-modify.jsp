...
<div id="main" class="wrap">
	...
	<div class="main">
		<h2>修改用户</h2>
		<div class="manage">
			<form method="post" action="Manage?opr=update" >
				<table class="form">
					<tr>
						<td class="field">用户名(*)：</td>
						<!-- 用户id -->
						<td><input type="hidden" name="uId" value="${id }" /></td>
						<td><input type="text" class="text" name="userName" value="${param.u_name }" readonly="readonly" /></td>
					</tr>
					<tr>
						<td class="field">真实姓名(*)：</td>
						<td><input type="text" class="text" name="name" value="${param.u_real_name }" /></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<c:if test="${param.u_sex =='女'}">
						 <input type="radio" name="sex" value="1" />男
						 <input type="radio" name="sex" value="1" checked="checked"/>女</td> 
						 </c:if> 
						 </td>						     
					</tr>
					<tr>
					...
					<tr>
						...
						<td><input type="text" class="text" name="mobile" value="${param.u_phone }" /></td>
					</tr>
					<tr>
