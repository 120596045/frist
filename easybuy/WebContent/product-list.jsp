	...
	<div class="main">
		<div class="product-list">
			...
			<ul class="product clearfix">
				...
				<li>
					<dl>
						<dt><a href="product-view.html" target="_self"><img src="images/product/7.jpg" /></a></dt>
				...
				<li>
					<dl>
						<dt><a href="product-view.html" target="_self"><img src="images/product/9.jpg" /></a></dt>
						<dd class="title"><a href="product-view.html" target="_self">爱国者MP4 全屏触摸多格式播放 4G</a></dd>
				...
				<li>
					<dl>
						...
						<dd class="title"><a href="product-view.html" target="_self">多美滋金装金盾3阶段幼儿配方奶粉</a></dd>
